...
class ViewXSLT extends View
{
	...
	private function processItem($node, $item)
	{
		if (is_object($item))
		{
	...
	private function processSet($node, $set)
	{
	...
	private function processObject($node, $item)
	{
	...
	private function processValue($node, $item)
	{
