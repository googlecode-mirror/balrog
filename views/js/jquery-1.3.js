...
(function() {
	...
	jQuery.fn = jQuery.prototype = {
		...
		domManip: function(args, table, callback) {
			...
			function root(elem, cur) {
				return table && jQuery.nodeName(elem, "table") && jQuery.nodeName(cur, "tr") ? (elem.getElementsByTagName("tbody")[0] ||
 ...
 : function(a, b) {
	...
	jQuery.event = {
		...
		add: function(elem, types, handler, data) {
			...
			var events = jQuery.data(elem, "events") || jQuery.data(elem, "events", {}), handle = jQuery.data(elem, "handle") ||
 ...
 br = i ? "Right" : "Bottom"; // bottom or right
		...
		jQuery.fn[type] = function(size) {
			...
			document.body["client" + name] :   // Get document width or height
